            ...
            <footer
                ...
                <motion.div
                    ...
                    <div className="md:flex md:justify-between">
                        <motion.div
                            ...
                            <a href="#" className="flex items-center">
                                ...
                                <img src={theme === 'dark' ? assets.logo1_dark : assets.logo1} className='w-40' alt="" />
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            <motion.div
                                ...
                                transition={{ duration: 0.9, ease: 'easeOut' }}
                                viewport={{ once: true }}>
                                <h2 className="mb-3 text-sm font-semibold text-heading uppercase hover:underline">
                                    <a href="#">Home</a>
                                </h2>
                                {/* list under home */}
                                <ul className="text-body font-medium text-sm">
                                    <li className='mb-3'>
                                        <a href="#services" className="hover:underline">Services</a>
                                    </li>
                                    <li className='mb-3'>
                                        <a href="#ourwork" className="hover:underline">Our Work</a>
                                    </li>
                                    <li className='mb-3'>
                            ...
                            <motion.div
                                ...
                                transition={{ duration: 0.9, ease: 'easeOut' }}
                                viewport={{ once: true }}>
                                <h2 className="mb-3 text-sm font-semibold text-heading uppercase">Follow us</h2>
                                <ul className="text-body font-medium text-sm">
                                    <li className="mb-3">
                                        <a href="https://github.com/themesberg/flowbite" className="hover:underline ">Youtube</a>
                                    </li>
                                    <li className='mb-3'>
                                        <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Whatsapp Community</a>
                                    </li>
                                    <li className='mb-3'>
                            ...
                            <motion.div
                                ...
                                transition={{ duration: 0.9, ease: 'easeOut' }}
                                viewport={{ once: true }}>
                                <h2 className="mb-3 text-sm font-semibold text-heading uppercase">Legal</h2>
                                <ul className="text-body font-medium text-sm">
                                    <li className="mb-3">
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-body sm:text-center">© 2026 <a href="https://flowbite.com/" className="hover:underline">Saroj Academics™</a>. All Rights Reserved.
                        </span>
